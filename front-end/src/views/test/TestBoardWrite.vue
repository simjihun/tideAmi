...
<template>
    <div>
        <!-- 팝업 내용 -->
        <el-dialog :title="ModalTitle" v-model:visible="openPopup" width="30%" center :close-on-click-modal="false">
            <!-- 본문 영역 -->
            <el-input placeholder="제목을 입력해 주세요" v-model="title"></el-input>
            <el-input style="margin-top: 30px" type="textarea" :rows="30" placeholder="내용을 입력해 주세요." v-model="content"> </el-input>
            <!-- dialog footer 영역 -->
